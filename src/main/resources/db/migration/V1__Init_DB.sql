...
(
    ...
    primary key (hotel_id, invoice_id)
) engine=InnoDB;
...
alter table hotel_invoice
    add constraint UK_3cl6hpmpd998p9klx9qxwhgsp unique (invoice_id);
alter table user_orders
    add constraint UK_oqipapb9ox7fhui5n2ttp9ab4 unique (orders_id);
alter table hotel_invoice
    add constraint FKavk1kcupjj0i9yxpfw2oyffeo foreign key (invoice_id) references invoice (id);
alter table hotel_invoice
